...
| [`explore-to-doc`](./explore-to-doc/) | Read `docs/index.md` before exploring; exploration docs under `docs/`; design/architecture under `docs/design/`; temporary reviews under `docs/tmp/` |
...
| `explore-to-doc` | Read `docs/index.md` first; exploration docs under `docs/*.md`; design/architecture under `docs/design/`; temporary reviews under `docs/tmp/` (not indexed) | Same behavior; keep workspace-level docs out of per-package `docs/` |
